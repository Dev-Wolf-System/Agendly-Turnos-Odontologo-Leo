        ...
        <div className="p-4 sm:p-6 bg-background/50">
          ...
          <div className="rounded-xl border border-border/40 bg-card p-3 sm:p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="text-xs sm:text-sm font-semibold">Agenda del dia</div>
              <div className="text-[10px] sm:text-xs text-muted-foreground">Abril 2026</div>
            </div>
            <div className="space-y-2">
              {[
                { time: "09:00", name: "Maria Garcia", type: "Consulta", bg: "bg-blue-500/10 border-blue-500/20" },
                { time: "10:30", name: "Juan Lopez", type: "Control", bg: "bg-emerald-500/10 border-emerald-500/20" },
                { time: "11:00", name: "Ana Martinez", type: "Limpieza", bg: "bg-purple-500/10 border-purple-500/20" },
...
const features = [
  {
    ...
    description: "Calendario inteligente con vistas diaria, semanal y lista. Control de solapamiento y recordatorios automaticos.",
    gradient: "from-blue-500 to-[var(--ht-primary)]",
  },
  {
    icon: ClipboardIcon,
    title: "Historial Medico",
    description: "Fichas completas por paciente con timeline de procedimientos, diagnosticos y documentos.",
    gradient: "from-[var(--ht-primary)] to-[var(--ht-accent)]",
  },
  {
    icon: CreditCardIcon,
    title: "Pagos y Facturacion",
    description: "Control financiero con KPIs, metodos de pago multiples y reportes detallados.",
    gradient: "from-[var(--ht-primary-light)] to-[var(--ht-accent-dark)]",
  },
  {
    icon: PackageIcon,
    title: "Inventario y Proveedores",
    description: "Stock en tiempo real, alertas de bajo inventario y gestion de proveedores.",
    gradient: "from-[var(--ht-accent)] to-fuchsia-500",
  },
  {
    icon: MessageIcon,
    title: "WhatsApp + IA",
    description: "Agente inteligente que atiende pacientes por WhatsApp: agenda turnos, responde consultas y envia recordatorios.",
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    icon: BuildingIcon,
    title: "Multi-clinica",
    description: "Panel de administracion SaaS para gestionar multiples clinicas, planes y suscripciones.",
...
const howItWorks = [
  {
    step: "01",
    title: "Registrate",
    description: "Crea tu cuenta en menos de 2 minutos. Sin tarjeta de credito.",
    icon: (
  ...
  },
  {
    step: "02",
    title: "Configura",
    description: "Personaliza horarios, profesionales, tratamientos y mas desde un panel intuitivo.",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    step: "03",
    title: "Gestiona",
    description: "Empieza a atender pacientes, agendar turnos y crecer tu negocio desde el dia uno.",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const testimonials = [
  {
    ...
    role: "Directora — Centro Odontologico Sonrisa",
    text: "Desde que usamos Avax Health, la gestion de turnos paso de ser un caos a algo automatico. Nuestros pacientes reciben recordatorios y la agenda se organiza sola.",
    avatar: "LM",
  },
  {
    name: "Dr. Martin Alvarez",
    role: "Kinesiologo — Kinesis Centro",
    text: "El historial medico digital nos ahorro horas de papelereo. Ahora tengo todo el historial de cada paciente en segundos, desde cualquier dispositivo.",
    avatar: "MA",
  },
  {
    name: "Lic. Carolina Vega",
    role: "Administradora — Clinica Integral Salud",
    text: "El control financiero y los reportes nos dieron visibilidad real del negocio. Por primera vez sabemos exactamente cuanto facturamos por profesional.",
    avatar: "CV",
  },
];
...
const audiences = [
  {
    title: "Consultorios",
    description: "Profesionales independientes que quieren digitalizar su practica y ahorrar tiempo.",
    icon: (
  ...
  {
    title: "Clinicas",
    description: "Equipos de 2 a 20 profesionales que necesitan coordinar agendas y compartir historiales.",
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Redes de salud con multiples sedes que necesitan gestion centralizada y reportes consolidados.",
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div ref={containerRef}>
        ...
        <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-12 lg:px-8 lg:pt-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="reveal reveal-delay-3 mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-[var(--ht-primary)] to-[var(--ht-accent-dark)] px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-[var(--ht-primary)]/25 hover:from-[var(--ht-primary)] hover:to-[var(--ht-accent)] hover:shadow-[var(--ht-primary)]/40 transition-all"
              >
                Comenzar gratis
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Desde consultorios individuales hasta redes de clinicas.
            </p>
          </div>
      ...
      <section className="relative py-20 sm:py-28">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Una plataforma integral que reemplaza multiples herramientas dispersas.
            </p>
          </div>
      ...
      <section className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Registrate y tene tu clinica funcionando en minutos.
            </p>
          </div>
      ...
      <section className="relative py-16 sm:py-20 reveal">
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-b from-[var(--ht-primary)]/[0.03] to-transparent" />
        </div>
      ...
      <section className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Profesionales de la salud que transformaron su gestion.
            </p>
          </div>
            ...
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 border-t border-border/40 pt-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[var(--ht-primary)] to-[var(--ht-accent-dark)] text-xs font-bold text-white">
                    {t.avatar}
                  </div>
                  <div>
      ...
      <section className="relative py-20 sm:py-28">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Conecta WhatsApp, calendario, pagos y mas desde un solo lugar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="reveal space-y-6">
              {[
                { title: "Recordatorios automaticos", desc: "Tus pacientes reciben recordatorios por WhatsApp antes de cada turno. Reduce inasistencias hasta un 60%." },
                { title: "Reportes en tiempo real", desc: "Dashboard con KPIs de turnos, ingresos, pacientes y ocupacion. Toma decisiones basadas en datos." },
                { title: "Multi-profesional", desc: "Cada profesional tiene su agenda, sus pacientes y sus estadisticas. Gestion centralizada." },
                { title: "Seguridad y privacidad", desc: "Datos encriptados, roles y permisos por usuario. Cumplimos con los estandares de proteccion de datos de salud." },
              ].map((f) => (
            ...
            {/* Mini illustration - simplified dashboard card */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-[var(--ht-primary)] to-[#0d1f33] px-6 py-16 sm:px-16 sm:py-20 text-center">
            ...
            <p className="relative mt-4 text-lg text-white/70 max-w-xl mx-auto">
              Sin tarjeta de credito. Cancela en cualquier momento. Soporte incluido desde el dia uno.
            </p>
